...
class PlaybackService : Service() {
    ...
    override fun onCreate() {
        ...
        mediaSession =
            MediaSessionCompat(this, "AIPlayerMediaSession").apply {
                setCallback(
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel =
                NotificationChannel(CHANNEL_ID, "播放控制通知栏", NotificationManager.IMPORTANCE_LOW)
                    .apply {
    ...
    private fun updateNotification() {
        ...
        val favoriteIntent =
            Intent(this, PlaybackService::class.java).apply { action = ACTION_FAVORITE }
        val favoritePI =
            PendingIntent.getService(
                this,
                5,
        ...
        val blacklistIntent =
            Intent(this, PlaybackService::class.java).apply { action = ACTION_BLACKLIST }
        val blacklistPI =
            PendingIntent.getService(
                this,
                6,
        ...
        updateNotificationJob =
            serviceScope.launch {
                ...
                if (albumArt == null) {
                    ...
                    // 3. 在后台挂起加载封面
                    albumArt =
                        withContext(Dispatchers.IO) { song.loadCover(this@PlaybackService, 200) }
                }
